...
catchphrase: "Pre-configured for your exact business type"
icon: "fa-solid fa-gavel"
relatedTags: ["compliance", "regulatory", "fsanz"]
weight: 16
...
{{< stats-grid >}}
{{< stat number="8" unit="states" >}}NSW, VIC, QLD, SA, WA, TAS, NT, ACT{{< /stat >}}
{{< stat number="6" unit="species" >}}Beef, pork, lamb, poultry, game, offal{{< /stat >}}
{{< stat number="1000+" unit="reqs" >}}Regulatory requirements pre-loaded{{< /stat >}}
{{< stat number="100" unit="%" >}}Meat processing focus{{< /stat >}}
{{< /stats-grid >}}

## Industry-Specific Features

{{< benefit-cards >}}
{{< benefit icon="fa-solid fa-cow" title="Species-Specific Workflows" >}}
...
{{< benefit icon="fa-solid fa-fire-burner" title="FSANZ Cooking Matrices Built-In" >}}
...
{{< benefit icon="fa-solid fa-truck" title="Vehicle Hygiene Forms" >}}
...
{{< benefit icon="fa-solid fa-trash" title="Condemned Stock Tracking" >}}
...
{{< benefit icon="fa-solid fa-wheat-awn" title="Allergen Management" >}}
...
{{< benefit icon="fa-solid fa-building" title="Business Type Filtering" >}}
...
{{< tech-specs title="Retail Butcher Shops" >}}
...
{{< tech-specs title="Small-Medium Processors" >}}
...
{{< tech-specs title="Abattoirs & Slaughter Facilities" >}}
...
{{< tech-specs title="Contract Processors & Toll Services" >}}
